    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printDouble(
        &sample->drive, "drive", indent_level + 1);    

    RTICdrType_printDouble(
        &sample->steer, "steer", indent_level + 1);    

    RTICdrType_printLong(
        &sample->lamp_mode, "lamp_mode", indent_level + 1);    

    RTICdrType_printLong(
        &sample->horn_voice, "horn_voice", indent_level + 1);    
