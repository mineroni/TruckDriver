...
> make -f makefile_driveAssembly_armv8Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_driveAssembly_armv8Linux4gcc7.3.0 DEBUG=1
...
Run C:\Program Files\rti_connext_dds-6.1.1\bin\../resource/scripts/rtisetenv_armv8Linux4gcc7.3.0.bash
...
> objs/armv8Linux4gcc7.3.0/driveAssembly_publisher -d <domain_id> -s <sample_count>
> objs/armv8Linux4gcc7.3.0/driveAssembly_subscriber -d <domain_id> -s <sample_count>
