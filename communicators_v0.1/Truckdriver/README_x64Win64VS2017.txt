...
data type DriveAssembly from driveAssembly.idl.
This example builds two applications, named driveAssembly_publisher and
driveAssembly_subscriber.
...
1. Launch Visual Studio in one of two ways:
        - By typing driveAssembly-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          driveAssembly-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   driveAssembly_publisher or driveAssembly_subscriber and
...
To modify the data being sent: edit the driveAssembly_publisher.cxx
file where it says 
...
1. Right-click driveAssembly_publisher and choose Debug > Start new instance.
2. Right-click driveAssembly_subscriber and choose Debug > Start new instance.
...
> objs\x64Win64VS2017\driveAssembly_publisher.exe -d <domain_id> -s <sample_count>
> objs\x64Win64VS2017\driveAssembly_subscriber.exe -d <domain_id> -s <sample_count>
